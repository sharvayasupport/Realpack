                  ...
                  <div class="search-cat-box p-2">
                    <div class="row m-0">
                      <div class="col-lg-6 col-md-6 border-cat py-2 px-4 position-relative">
                          <!-- fas fa-bars !-->
                        <button role="tab" class="product-btn"><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_category_icon')); ?> me-2"></i><?php echo esc_html_e('ALL CATEGORIES','ecommerce-solution'); ?><i class="<?php echo esc_attr(get_theme_mod('ecommerce_solution_category_show_down_icon','fas fa-sort-down')); ?> ms-4"></i></button>
