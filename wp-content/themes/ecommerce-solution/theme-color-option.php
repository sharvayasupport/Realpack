<?php
	...
	$ecommerce_solution_custom_css .='.site-title a{';
		$ecommerce_solution_custom_css .='color: '.esc_attr($ecommerce_solution_site_title_color).';';
	$ecommerce_solution_custom_css .='}';
...
// Sub menu color
	...
	$ecommerce_solution_custom_css .='.primary-navigation ul.sub-menu a, .primary-navigation ul.sub-menu li a{';
...
// submenu hover color
	...
	$ecommerce_solution_custom_css .='.primary-navigation ul.sub-menu li a:hover{';
