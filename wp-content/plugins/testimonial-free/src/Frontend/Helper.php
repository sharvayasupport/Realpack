...
class Helper {
	...
	public static function sp_testimonial_html_show( $post_id, $setting_options, $shortcode_data, $main_section_title ) {
		...
		$space       = isset( $shortcode_data['testimonial_margin'] ) ? $shortcode_data['testimonial_margin'] : array(
			'top'   => '20',
			'right' => '20',
		);
